...
then
	...
	then
		...
		then
			...
			#echo 'press : than q to exit'
			#less -j-1 $homedir/.foxcmds/historyview.txt
...
$homedir/.foxcmds/plugins/plugins.sh
if [ $cddir == "~" ]
then
	cd $homedir
	cddirdis='~'
    ...
    then
        ...
        then
        	...
        	then
				...
				then
				read -r argexp <<< $arg
				read -r arg1exp <<< ${arg1} #; echo $arg1exp
				read -r arg2exp <<< ${arg2} #; echo $arg2exp
				read -r arg3exp <<< ${arg3} #; echo $arg3exp
				read -r arg4exp <<< ${arg4} #; echo $arg4exp
				#echo "$input $arg is $argexp $arg1 is $arg1exp $arg2 is $arg2exp $arg3 is $arg3exp $arg4 is $arg4exp" 
        			$input $argexp $arg1exp $arg2exp $arg3exp $arg4exp
				else
